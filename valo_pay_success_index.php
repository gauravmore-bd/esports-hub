...
<link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css'><link rel="stylesheet" href="valo_pay_success_style.css">
...
try {
    ...
    <ul style="color: black;">
        <li><strong>Tournament Name:</strong> eSports Valorant Tournament</li>
...
$sql = "UPDATE valo_register SET fldprice = '$txtprice' WHERE fldemail = '$email'";
