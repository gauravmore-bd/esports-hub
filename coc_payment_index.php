      ...
      <div class="col-xs-8">
        ...
        <div class="checkout_details">
          <div class="col-xs-12">
            ...
            <form class="checkout_form" action="coc_pay_success_index.php" method="POST">
              ...
              <a href="coc_pay_success_index.php"><button class="checkout_pay" type="submit">Pay &raquo;</button></a>
            </form>
          </div>
        </div>
      </div>
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/jquery.payment/3.0.0/jquery.payment.min.js.map'></script><script  src="coc_payment_script.js"></script>
