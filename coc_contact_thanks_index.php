<html>
	<head>
	<title>eSports</title>
		<link rel="stylesheet" href="coc_thanks_style.css">
		</head>
	<body>
	<audio id="backgroundAudio" preload="auto"  autoplay loop>
		...
		<div class="card">
			<div class="details">
				...
				<a href="coc_payment_index.php">Payment</a>
			</div>
			<div class="image-container">
				<img src="prince.png" alt="guard" class="main-image"/>
			</div>
...
$sql = "INSERT INTO `coc_register` (`Id`, `fldname`, `fldage`, `fldemail`, `fldphonenumber`, `flddob`, `fldgameid`) VALUES ('0', '$txtname', '$txtage', '$txtemail', '$txtphonenumber', '$txtdob', '$txtgameid')";
