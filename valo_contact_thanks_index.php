<html>
	<head>
		<title>eSports</title>
		<link rel="stylesheet" href="valo_thanks_style.css">
		</head>
	<body>
	<audio id="backgroundAudio" preload="auto"  autoplay loop>
		...
		<div class="card">
			<div class="details">
				...
				<a href="valo_payment_index.php">Payment</a>
			</div>
			<div class="image-container">
				<img src="yoru11.png" alt="guard" class="main-image"/>
			</div>
...
$sql = "INSERT INTO `valo_register` (`Id`, `fldname`, `fldage`, `fldemail`, `fldphonenumber`, `flddob`, `fldgameid`) VALUES ('0', '$txtname', '$txtage', '$txtemail', '$txtphonenumber', '$txtdob', '$txtgameid')";
