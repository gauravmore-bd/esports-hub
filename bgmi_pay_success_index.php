...
<link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css'><link rel="stylesheet" href="bgmi_pay_success_style.css">
...
try {
    ...
    <ul style="color: black;">
        <li><strong>Tournament Name:</strong> eSports BGMI Tournament</li>
...
$sql = "UPDATE bgmi_register SET fldprice = '$txtprice' WHERE fldemail = '$email'";
